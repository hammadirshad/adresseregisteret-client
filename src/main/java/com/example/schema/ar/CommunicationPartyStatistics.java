...
/**
 * Java class for CommunicationPartyStatistics complex type.
 *
...
@XmlType(
        ...
        propOrder = {"businessTypeStatistics"})
public class CommunicationPartyStatistics {
     ...
     *
     * @return possible object is {@link JAXBElement }{@code <}{@link ArrayOfBusinessTypeStatistics
     * }{@code >}
     */
     ...
     *
     * @param value allowed object is {@link JAXBElement }{@code <}{@link ArrayOfBusinessTypeStatistics
     *              }{@code >}
     */
    public void setBusinessTypeStatistics(JAXBElement<ArrayOfBusinessTypeStatistics> value) {
        this.businessTypeStatistics = value;
    }
}
