...
/**
 * Java class for ArrayOfEntityLogEntryData complex type.
 *
...
@XmlType(
        name = "ArrayOfEntityLogEntryData",
        namespace = "http://register.nhn.no/Common",
        propOrder = {"entityLogEntryData"})
public class ArrayOfEntityLogEntryData {
   ...
   * there is not a <CODE>set</CODE> method for the entityLogEntryData property.
   *
   ...
   * </pre>
   *
   * <p>Objects of the following type(s) are allowed in the list {@link EntityLogEntryData }
   */
