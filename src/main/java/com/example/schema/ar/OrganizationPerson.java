...
/**
 * Java class for OrganizationPerson complex type.
 *
...
@XmlType(
        ...
        propOrder = {"departments", "organizations", "person", "properties", "title"})
public class OrganizationPerson extends CommunicationParty {
     ...
     *
     * @return possible object is {@link JAXBElement }{@code <}{@link Person }{@code >}
     */
     ...
     *
     * @param value allowed object is {@link JAXBElement }{@code <}{@link Person }{@code >}
     */
