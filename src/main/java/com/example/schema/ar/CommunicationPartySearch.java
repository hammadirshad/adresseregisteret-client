...
/**
 * Java class for CommunicationPartySearch complex type.
 *
...
@XmlType(
        ...
        propOrder = {"page", "pageSize", "searchConstraints"})
public class CommunicationPartySearch {
   ...
   *
   * @return possible object is {@link JAXBElement }{@code <}{@link ArrayOfKeyValuePairOfstringstring
   * }{@code >}
   */
   ...
   *
   * @param value allowed object is {@link JAXBElement }{@code <}{@link ArrayOfKeyValuePairOfstringstring
   *              }{@code >}
   */
