...
/**
 * Java class for ArrayOfEntityLogEntry complex type.
 *
...
@XmlType(
        name = "ArrayOfEntityLogEntry",
        namespace = "http://register.nhn.no/Common",
        propOrder = {"entityLogEntry"})
public class ArrayOfEntityLogEntry {
   ...
   * there is not a <CODE>set</CODE> method for the entityLogEntry property.
   *
   ...
   * </pre>
   *
   * <p>Objects of the following type(s) are allowed in the list {@link EntityLogEntry }
   */
