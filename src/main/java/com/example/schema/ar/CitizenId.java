...
/**
 * Java class for CitizenId complex type.
 *
...
@XmlType(
        ...
        propOrder = {"citizenIdType", "id", "sex"})
public class CitizenId {
   ...
   *
   * @return possible object is {@link CitizenIdType }
   */
   ...
   *
   * @param value allowed object is {@link CitizenIdType }
   */
