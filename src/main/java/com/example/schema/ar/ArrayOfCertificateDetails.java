...
/**
 * Java class for ArrayOfCertificateDetails complex type.
 *
...
public class ArrayOfCertificateDetails {
   ...
   * there is not a <CODE>set</CODE> method for the certificateDetails property.
   *
   ...
   * </pre>
   *
   * <p>Objects of the following type(s) are allowed in the list {@link CertificateDetails }
   */
