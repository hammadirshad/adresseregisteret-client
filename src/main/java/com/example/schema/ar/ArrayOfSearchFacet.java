...
/**
 * Java class for ArrayOfSearchFacet complex type.
 *
...
public class ArrayOfSearchFacet {
   ...
   * there is not a <CODE>set</CODE> method for the searchFacet property.
   *
   ...
   * </pre>
   *
   * <p>Objects of the following type(s) are allowed in the list {@link SearchFacet }
   */
