...
@XmlType(
        name = "SearchResult",
        propOrder = {"facets", "results", "serverTime", "totalResults"})
public class SearchResult {
   ...
   *
   * @return possible object is {@link JAXBElement }{@code <}{@link ArrayOfSearchFacet }{@code >}
   */
   ...
   *
   * @param value allowed object is {@link JAXBElement }{@code <}{@link ArrayOfSearchFacet }{@code
   *              >}
   */
