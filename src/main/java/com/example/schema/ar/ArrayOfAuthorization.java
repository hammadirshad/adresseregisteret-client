...
/**
 * Java class for ArrayOfAuthorization complex type.
 *
...
@XmlType(
        name = "ArrayOfAuthorization",
        namespace = "http://register.nhn.no/HPR",
        propOrder = {"authorization"})
public class ArrayOfAuthorization {
   ...
   * there is not a <CODE>set</CODE> method for the authorization property.
   *
   ...
   * </pre>
   *
   * <p>Objects of the following type(s) are allowed in the list {@link Authorization }
   */
