...
/**
 * Java class for EntityLogEntry complex type.
 *
...
@XmlType(
        ...
        propOrder = {"byUser", "changes", "description", "time"})
public class EntityLogEntry {
   ...
   *
   * @return possible object is {@link JAXBElement }{@code <}{@link ArrayOfEntityLogEntryData
   * }{@code >}
   */
   ...
   *
   * @param value allowed object is {@link JAXBElement }{@code <}{@link ArrayOfEntityLogEntryData
   *              }{@code >}
   */
