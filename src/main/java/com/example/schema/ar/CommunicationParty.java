...
/**
 * Java class for CommunicationParty complex type.
 *
 ...
 *         &lt;element name="IsValidCommunicationParty" type="{http://www.w3.org/2001/XMLSchema}boolean" minOccurs="0"/>
...
@XmlSeeAlso({Department.class, OrganizationPerson.class, Organization.class, Service.class})
public class CommunicationParty {
  ...
  @XmlElement(name = "IsValidCommunicationParty")
  protected Boolean isValidCommunicationParty;
  ...
  /**
   * Gets the value of the isValidCommunicationParty property.
   *
   * @return possible object is {@link Boolean }
   */
  public Boolean isIsValidCommunicationParty() {
    return isValidCommunicationParty;
  }

  /**
   * Sets the value of the isValidCommunicationParty property.
   *
   * @param value allowed object is {@link Boolean }
   */
  public void setIsValidCommunicationParty(Boolean value) {
    this.isValidCommunicationParty = value;
  }
