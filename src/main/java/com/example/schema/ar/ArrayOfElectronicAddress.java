...
/**
 * Java class for ArrayOfElectronicAddress complex type.
 *
...
@XmlType(
        name = "ArrayOfElectronicAddress",
        namespace = "http://register.nhn.no/Common",
        propOrder = {"electronicAddress"})
public class ArrayOfElectronicAddress {
   ...
   * there is not a <CODE>set</CODE> method for the electronicAddress property.
   *
   ...
   * </pre>
   *
   * <p>Objects of the following type(s) are allowed in the list {@link ElectronicAddress }
   */
