...
/**
 * Java class for ArrayOfSpeciality complex type.
 *
...
@XmlType(
        name = "ArrayOfSpeciality",
        namespace = "http://register.nhn.no/HPR",
        propOrder = {"speciality"})
public class ArrayOfSpeciality {
   ...
   * there is not a <CODE>set</CODE> method for the speciality property.
   *
   ...
   * </pre>
   *
   * <p>Objects of the following type(s) are allowed in the list {@link Speciality }
   */
