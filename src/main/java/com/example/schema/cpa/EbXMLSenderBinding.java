...
public class EbXMLSenderBinding {
   ...
   *
   * @return possible object is {@link SenderNonRepudiation }
   */
   ...
   *
   * @param value allowed object is {@link SenderNonRepudiation }
   */
   ...
   *
   * @return possible object is {@link SenderDigitalEnvelope }
   */
   ...
   *
   * @param value allowed object is {@link SenderDigitalEnvelope }
   */
   ...
   * there is not a <CODE>set</CODE> method for the namespaceSupported property.
   *
   ...
   * </pre>
   *
   * <p>Objects of the following type(s) are allowed in the list {@link NamespaceSupported }
   */
