...
public class PartyInfo {
   ...
   * there is not a <CODE>set</CODE> method for the partyId property.
   *
   ...
   * </pre>
   *
   * <p>Objects of the following type(s) are allowed in the list {@link PartyId }
   */
   ...
   * <p>This accessor method returns a reference to the live list, not a snapshot. Therefore any
   * modification you make to the returned list will be present inside the JAXB object. This is why
   * there is not a <CODE>set</CODE> method for the partyRef property.
   *
   * <p>For example, to add a new item, do as follows:
   *
   * <pre>
   ...
   * </pre>
   *
   * <p>Objects of the following type(s) are allowed in the list {@link PartyRef }
   */
   ...
   * <p>This accessor method returns a reference to the live list, not a snapshot. Therefore any
   * modification you make to the returned list will be present inside the JAXB object. This is why
   * there is not a <CODE>set</CODE> method for the collaborationRole property.
   *
   * <p>For example, to add a new item, do as follows:
   *
   * <pre>
   ...
   * </pre>
   *
   * <p>Objects of the following type(s) are allowed in the list {@link CollaborationRole }
   */
   ...
   * <p>This accessor method returns a reference to the live list, not a snapshot. Therefore any
   * modification you make to the returned list will be present inside the JAXB object. This is why
   * there is not a <CODE>set</CODE> method for the securityDetails property.
   *
   * <p>For example, to add a new item, do as follows:
   *
   * <pre>
   ...
   * </pre>
   *
   * <p>Objects of the following type(s) are allowed in the list {@link SecurityDetails }
   */
   ...
   * <p>This accessor method returns a reference to the live list, not a snapshot. Therefore any
   * modification you make to the returned list will be present inside the JAXB object. This is why
   * there is not a <CODE>set</CODE> method for the deliveryChannel property.
   *
   * <p>For example, to add a new item, do as follows:
   *
   * <pre>
   ...
   * </pre>
   *
   * <p>Objects of the following type(s) are allowed in the list {@link DeliveryChannel }
   */
   ...
   * <p>This accessor method returns a reference to the live list, not a snapshot. Therefore any
   * modification you make to the returned list will be present inside the JAXB object. This is why
   * there is not a <CODE>set</CODE> method for the transport property.
   *
   * <p>For example, to add a new item, do as follows:
   *
   * <pre>
   ...
   * </pre>
   *
   * <p>Objects of the following type(s) are allowed in the list {@link Transport }
   */
   ...
   * <p>This accessor method returns a reference to the live list, not a snapshot. Therefore any
   * modification you make to the returned list will be present inside the JAXB object. This is why
   * there is not a <CODE>set</CODE> method for the docExchange property.
   *
   * <p>For example, to add a new item, do as follows:
   *
   * <pre>
   ...
   * </pre>
   *
   * <p>Objects of the following type(s) are allowed in the list {@link DocExchange }
   */
   ...
   * <p>This accessor method returns a reference to the live list, not a snapshot. Therefore any
   * modification you make to the returned list will be present inside the JAXB object. This is why
   * there is not a <CODE>set</CODE> method for the overrideMshActionBinding property.
   *
   * <p>For example, to add a new item, do as follows:
   *
   * <pre>
   ...
   * </pre>
   *
   * <p>Objects of the following type(s) are allowed in the list {@link OverrideMshActionBinding }
   */
