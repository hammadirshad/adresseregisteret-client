...
@XmlType(
        name = "",
        propOrder = {"transportProtocol", "accessAuthentication", "transportClientSecurity"})
...
public class TransportSender {
   ...
   * there is not a <CODE>set</CODE> method for the accessAuthentication property.
   *
   ...
   * </pre>
   *
   * <p>Objects of the following type(s) are allowed in the list {@link AccessAuthenticationType }
   */
   ...
   *
   * @return possible object is {@link TransportClientSecurity }
   */
   ...
   *
   * @param value allowed object is {@link TransportClientSecurity }
   */
