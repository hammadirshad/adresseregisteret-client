...
/**
 * Java class for ArrayOfSearchResultFacetEntry complex type.
 *
...
@XmlType(
        ...
        propOrder = {"searchResultFacetEntry"})
public class ArrayOfSearchResultFacetEntry {
   ...
   * there is not a <CODE>set</CODE> method for the searchResultFacetEntry property.
   *
   ...
   * </pre>
   *
   * <p>Objects of the following type(s) are allowed in the list {@link SearchResultFacetEntry }
   */
