...
/**
 * Java class for ArrayOfSpecialCompetence complex type.
 *
...
@XmlType(
        name = "ArrayOfSpecialCompetence",
        namespace = "http://register.nhn.no/HPR",
        propOrder = {"specialCompetence"})
public class ArrayOfSpecialCompetence {
   ...
   * there is not a <CODE>set</CODE> method for the specialCompetence property.
   *
   ...
   * </pre>
   *
   * <p>Objects of the following type(s) are allowed in the list {@link SpecialCompetence }
   */
