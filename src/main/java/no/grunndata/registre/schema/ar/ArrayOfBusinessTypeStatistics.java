...
/**
 * Java class for ArrayOfBusinessTypeStatistics complex type.
 *
...
public class ArrayOfBusinessTypeStatistics {
   ...
   * there is not a <CODE>set</CODE> method for the businessTypeStatistics property.
   *
   ...
   * </pre>
   *
   * <p>Objects of the following type(s) are allowed in the list {@link BusinessTypeStatistics }
   */
