...
/**
 * Java class for ArrayOfOrganizationPerson complex type.
 *
...
public class ArrayOfOrganizationPerson {
   ...
   * there is not a <CODE>set</CODE> method for the organizationPerson property.
   *
   ...
   * </pre>
   *
   * <p>Objects of the following type(s) are allowed in the list {@link OrganizationPerson }
   */
