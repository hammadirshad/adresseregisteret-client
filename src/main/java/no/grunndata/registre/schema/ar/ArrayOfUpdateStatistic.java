...
/**
 * Java class for ArrayOfUpdateStatistic complex type.
 *
...
public class ArrayOfUpdateStatistic {
   ...
   * there is not a <CODE>set</CODE> method for the updateStatistic property.
   *
   ...
   * </pre>
   *
   * <p>Objects of the following type(s) are allowed in the list {@link UpdateStatistic }
   */
