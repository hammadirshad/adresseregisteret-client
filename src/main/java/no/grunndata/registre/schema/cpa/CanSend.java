...
@XmlType(
        name = "",
        propOrder = {"thisPartyActionBinding", "otherPartyActionBinding", "canReceive"})
...
public class CanSend {
   ...
   * there is not a <CODE>set</CODE> method for the canReceive property.
   *
   ...
   * </pre>
   *
   * <p>Objects of the following type(s) are allowed in the list {@link CanReceive }
   */
