...
@XmlType(
        name = "ActionBinding.type",
        propOrder = {"businessTransactionCharacteristics", "actionContext", "channelId", "any"})
public class ActionBindingType {
   ...
   * there is not a <CODE>set</CODE> method for the channelId property.
   *
