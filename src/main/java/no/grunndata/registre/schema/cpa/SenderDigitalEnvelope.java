...
@XmlType(
        name = "",
        propOrder = {"digitalEnvelopeProtocol", "encryptionAlgorithm", "encryptionSecurityDetailsRef"})
...
public class SenderDigitalEnvelope {
   ...
   * there is not a <CODE>set</CODE> method for the encryptionAlgorithm property.
   *
   ...
   * </pre>
   *
   * <p>Objects of the following type(s) are allowed in the list {@link EncryptionAlgorithm }
   */
