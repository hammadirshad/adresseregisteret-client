package no.grunndata.registre.grunndata.cpp.mapper;

import lombok.RequiredArgsConstructor;
import lombok.SneakyThrows;
import lombok.extern.slf4j.Slf4j;
import no.grunndata.registre.model.*;
import no.grunndata.registre.schema.cpa.*;
import no.grunndata.registre.schema.xmldsig.KeyInfoType;
import no.grunndata.registre.schema.xmldsig.X509DataType;
